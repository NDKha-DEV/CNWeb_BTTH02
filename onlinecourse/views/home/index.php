...
<body>
    ...
    <div class="header">
        ...
        <div class="actions">
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <a href="course/index" class="btn btn-info">📂 Quản lý khóa học</a>
                <a href="course/create" class="btn btn-success">+ Tạo mới</a>
            ...
            <?php else: ?>
                ...
                <a href="auth/register" class="btn btn-success">Đăng ký</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="hero">
        ...
        <?php if (!isset($_SESSION['user_id'])): ?>
            <p>Vui lòng <a href="auth/login">đăng nhập</a> để bắt đầu tạo khóa học của bạn.</p>
        <?php endif; ?>
    </div>
